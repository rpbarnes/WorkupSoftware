...
fullPath = '/Users/StupidRobot/Desktop/160906_ODNP_DROPLET_DILUTION'
exps = r_[22:27,304]

fl = fnb.figlistl()
expTimes,expTimeM,absTime = nmr.returnExpTimes(fullPath,exps,dnpExp = False,operatingSys = 'posix') # this is not a good way because the experiment numbers must be set right.
enhancementPowers,fl.figurelist = nmr.returnSplitPowers(fullPath,'t1_powers',bufferVal = 5,absTime = absTime)
##timeDropStart = 20
##dnpPowers = False
##threshold = 0.1
