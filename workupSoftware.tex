...
\begin{enumerate}
    \item $\Box$ You need to wrap the bare code into functions and classes.
    ...
    \item $\Box$ Include the EPR double integral workup as part of the software.
    \item $\Box$ Fix the file browser functionality so this doesn't crash so easily.
    \item $\Box$ Fit the $T_1$ raw data in the log space. This should be much more robust to weridness. Also you should plot the data in this space.
