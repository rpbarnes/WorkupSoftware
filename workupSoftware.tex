...
\section{Bugs:}
\begin{enumerate}
    \item $\Box$ The EPR double integration falls apart for some reason for the 10 uM sample of 4 OHT. This could be a threshold problem, you must look into this.
